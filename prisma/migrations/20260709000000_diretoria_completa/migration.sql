...
ALTER TYPE "AuditAction" ADD VALUE 'api_key_updated';
...
ALTER TYPE "AuditAction" ADD VALUE 'webhook_toggled';
ALTER TYPE "AuditAction" ADD VALUE 'webhook_deleted';
ALTER TYPE "AuditAction" ADD VALUE 'external_mcp_server_created';
ALTER TYPE "AuditAction" ADD VALUE 'external_mcp_server_updated';
ALTER TYPE "AuditAction" ADD VALUE 'external_mcp_server_toggled';
ALTER TYPE "AuditAction" ADD VALUE 'external_mcp_server_deleted';
ALTER TYPE "AuditAction" ADD VALUE 'kb_document_created';
ALTER TYPE "AuditAction" ADD VALUE 'kb_document_deleted';
ALTER TYPE "AuditAction" ADD VALUE 'report_preset_created';
ALTER TYPE "AuditAction" ADD VALUE 'report_preset_deleted';
ALTER TYPE "AuditAction" ADD VALUE 'report_exported';

-- AlterTable
ALTER TABLE "fato_nota_fiscal" ADD COLUMN     "is_venda_externa" BOOLEAN;

-- AlterTable
ALTER TABLE "fato_pedido" ADD COLUMN     "bucket_demanda" TEXT,
ADD COLUMN     "categoria_operacao" TEXT,
ADD COLUMN     "pendencia_etapa" TEXT;
...
-- CreateTable
CREATE TABLE "user_diretoria_access" (
    "id" UUID NOT NULL,
...
-- CreateTable
CREATE TABLE "user_diretoria_uf" (
    "id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
...
-- CreateTable
CREATE TABLE "diretoria_evento_colaborador" (
    "id" UUID NOT NULL,
...
-- CreateTable
CREATE TABLE "diretoria_evento_anexo" (
    "id" UUID NOT NULL,
    "evento_id" UUID NOT NULL,
    "nome" TEXT NOT NULL,
    "url" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "diretoria_relatorio" (
    "id" UUID NOT NULL,
    "tela" TEXT NOT NULL,
    "dono_user_id" UUID,
...
-- CreateTable
CREATE TABLE "diretoria_relatorio_bloco" (
    "id" UUID NOT NULL,
...
-- CreateIndex
CREATE INDEX "user_diretoria_access_user_id_idx" ON "user_diretoria_access"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "user_diretoria_access_user_id_capability_key" ON "user_diretoria_access"("user_id", "capability");

-- CreateIndex
CREATE INDEX "user_diretoria_uf_user_id_idx" ON "user_diretoria_uf"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "user_diretoria_uf_user_id_uf_key" ON "user_diretoria_uf"("user_id", "uf");

-- CreateIndex
CREATE INDEX "diretoria_evento_inicio_idx" ON "diretoria_evento"("inicio");

-- CreateIndex
CREATE INDEX "diretoria_evento_colaborador_user_id_idx" ON "diretoria_evento_colaborador"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "diretoria_evento_colaborador_evento_id_user_id_key" ON "diretoria_evento_colaborador"("evento_id", "user_id");

-- CreateIndex
CREATE INDEX "diretoria_evento_anexo_evento_id_idx" ON "diretoria_evento_anexo"("evento_id");

-- CreateIndex
CREATE INDEX "diretoria_relatorio_tela_idx" ON "diretoria_relatorio"("tela");

-- CreateIndex
CREATE INDEX "diretoria_relatorio_dono_user_id_idx" ON "diretoria_relatorio"("dono_user_id");

-- CreateIndex
CREATE INDEX "diretoria_relatorio_bloco_relatorio_id_idx" ON "diretoria_relatorio_bloco"("relatorio_id");

-- CreateIndex
CREATE INDEX "fato_serial_produto_id_idx" ON "fato_serial"("produto_id");

-- CreateIndex
CREATE INDEX "fato_compra_recebida_cancelada_idx" ON "fato_compra"("recebida", "cancelada");

-- CreateIndex
CREATE INDEX "fato_pedido_item_pedido_id_idx" ON "fato_pedido_item"("pedido_id");

-- CreateIndex
CREATE INDEX "fato_pedido_item_produto_id_idx" ON "fato_pedido_item"("produto_id");

-- CreateIndex
CREATE INDEX "fato_nota_fiscal_is_venda_externa_idx" ON "fato_nota_fiscal"("is_venda_externa");

-- CreateIndex
CREATE INDEX "fato_pedido_bucket_demanda_idx" ON "fato_pedido"("bucket_demanda");

-- CreateIndex
CREATE INDEX "fato_pedido_categoria_operacao_idx" ON "fato_pedido"("categoria_operacao");
