...
export function mapPedidoRow(
  ...
  return {
    ...
    dataOrcamento: typeof raw.data_orcamento === "string" ? new Date(`${raw.data_orcamento}T00:00:00Z`) : null,
    dataAprovacao: typeof raw.data_aprovacao === "string" ? new Date(`${raw.data_aprovacao}T00:00:00Z`) : null,
    dataValidade: typeof raw.data_validade === "string" ? new Date(`${raw.data_validade}T00:00:00Z`) : null,
    dataPrevista: typeof raw.data_prevista === "string" ? new Date(`${raw.data_prevista}T00:00:00Z`) : null,
