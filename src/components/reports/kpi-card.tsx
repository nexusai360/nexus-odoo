...
export function KpiCard({
  ...
  return (
    <div className="group relative min-h-[124px] rounded-2xl border border-border bg-muted/30 px-4 pt-4 pb-4 transition-colors hover:border-foreground/20">
      {/* Label e icone na mesma linha flex com items-center: o label fica
          verticalmente centrado em relacao ao chip do icone. Padding e gap
          reduzidos pontualmente para caber "TOKENS ENTRADA" sem truncar. */}
      <div className="flex items-center justify-between gap-1.5">
        <p className="whitespace-nowrap text-[12px] font-medium uppercase tracking-wide text-muted-foreground">
          {label}
        </p>
        <div
          className={cn(
