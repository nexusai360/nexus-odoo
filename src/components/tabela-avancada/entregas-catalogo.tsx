...
export const COLUNAS: ColunaDef<LinhaEntrega>[] = [
  ...
  { key: "emitente", label: "Emitente", tipo: "texto", sortable: true, numeric: false, padrao: false, valor: (l) => l.emitente },
  { key: "cliente", label: "Cliente", tipo: "texto", sortable: true, numeric: false, padrao: true, valor: (l) => l.cliente },
  ...
  { key: "produto", label: "Produto", tipo: "texto", sortable: true, numeric: false, padrao: true, valor: (l) => l.produto },
  ...
  { key: "operacao", label: "Operação", tipo: "texto", sortable: true, numeric: false, padrao: false, valor: (l) => l.operacao },
  ...
  { key: "observacoes", label: "Observações", tipo: "texto", sortable: false, numeric: false, padrao: false, valor: (l) => l.observacoes },
  { key: "obsEntrega", label: "Obs entrega", tipo: "texto", sortable: false, numeric: false, padrao: false, valor: (l) => l.obsEntrega },
];
