...
const MAX: Record<Variant, string> = {
  // Cap reduzido para 15% do bump original (commit 8e7b7ef), com
  // K=0.0075 (15% do crescimento original). Aplicado uniformemente
  // a todas as variants:
  // - narrow: 1280 + (1480-1280)*0.15 = 1310
  // - wide:   1600 + (1840-1600)*0.15 = 1636
  // - compact/form/agent: 1280 + (1536-1280)*0.15 = 1318
  compact: "max-w-[clamp(1280px,calc(1280px+(100vw-1366px)*0.0075),1318px)]",
  form: "max-w-[clamp(1280px,calc(1280px+(100vw-1366px)*0.0075),1318px)]",
  agent: "max-w-[clamp(1280px,calc(1280px+(100vw-1366px)*0.0075),1318px)]",
  narrow: "max-w-[clamp(1280px,calc(1280px+(100vw-1366px)*0.0075),1310px)]",
