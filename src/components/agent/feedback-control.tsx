    ...
    <div ref={rootRef}>
      ...
      {!chosenOpt ? (
        <button
          ...
          className="nex-vote-pulse absolute -right-2 -bottom-2 flex h-6 w-6 cursor-pointer items-center justify-center rounded-md border border-blue-400/60 bg-blue-500/15 text-blue-600 shadow-sm transition-colors hover:bg-blue-500/35 hover:text-blue-700 hover:[animation-play-state:paused] focus-visible:ring-2 focus-visible:ring-blue-400/70 focus-visible:outline-none dark:text-blue-300"
        >
