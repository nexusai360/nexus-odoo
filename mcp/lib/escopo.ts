// mcp/lib/escopo.ts
// Helper de escopo de empresa, DOMINIO-NEUTRO (F4 Apresentacao, Onda 3.2).
// Generaliza o antigo mcp/tools/fiscal/_escopo-empresa.ts para que qualquer
// dominio que filtre por empresa (fiscal hoje; financeiro/comercial conforme a
// Onda 4 migra) reuse a MESMA resolucao e o MESMO aviso humanizado.
//
// Resolve a referencia textual (id, CNPJ ou nome) para empresaId + um descritor
// de escopo com aviso. Sem empresaRef: ramo grupo (considera o grupo todo).
