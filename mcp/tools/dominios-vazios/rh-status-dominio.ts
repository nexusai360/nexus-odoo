...
export const rhStatusDominio: ToolEntry<Input, Output> = {
  id: "rh_status_dominio",
  sempreVisivel: true,
  descricao:
    "Informa o status do domínio RH no Odoo da Matrix: módulo existente mas não operado (0 registros).",
