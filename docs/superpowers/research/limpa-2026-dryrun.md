# DRY-RUN , Purge pre-2026 (2026-06-11T16:24Z)

| tabela | criterio | a deletar | NULLs preservados | total | MB |
|---|---|---|---|---|---|
| raw_sped_documento_item_rastreabilidade | filho de raw_sped_documento_item | 160 | 0 | 43125 | 53 |
| raw_sped_documento_duplicata | filho de raw_sped_documento | 18237 | 0 | 22084 | 13 |
| raw_sped_documento_item | filho de raw_sped_documento | 173758 | 0 | 221649 | 924 |
...
| raw_sped_documento_volume | filho de raw_sped_documento | 16435 | 0 | 19293 | 10 |
...
| raw_finan_lancamento | quitado/baixado pago<2026 (vivos FICAM) | 76 | 0 | 11231 | 37 |
| raw_pedido_documento | data data_orcamento < 2026 | 81 | 0 | 1862 | 14 |
...
| raw_sped_documento | data data_emissao < 2026 | 39919 | 0 | 50362 | 213 |
