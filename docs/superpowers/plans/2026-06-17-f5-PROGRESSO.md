...
- [ ] **PRÓXIMO:** Onda E (monitoramento: origem Bubble/WhatsApp, aba "Chat", status por canal, sessões WhatsApp , POR ÚLTIMO, conflito com feat/nex-reconstrucao), Onda F (runbook n8n + e2e contra dado real).
