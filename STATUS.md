...
| **F5 — Integração WhatsApp** | Agente de IA por WhatsApp + chat in-app, Integrações, RAG | 🔄 **backend pronto; UI rework — sessão 2 fechada, sobram D2/D3/D5/G10 + polimento Consumo** |
